...
const branches: Branch[] = [
  ...
  },
  {
    ...
    body: "AI Wrapper, Cloud Shield, Scribe, Trace, and Clinical Triage (referral grading) — workflow capabilities under evaluation and development, not publicly launched products.",
    href: "/pipeline",
