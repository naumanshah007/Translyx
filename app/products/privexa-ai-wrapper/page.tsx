...
const pageDescription =
  "Privexa AI Wrapper is a secure LLM gateway that helps organisations use AI systems without sending sensitive data in its original form. Built by Privexa Limited, clinically positioned through Translyx.";

export const metadata: Metadata = {
  title: "Privexa AI Wrapper — Secure LLM Gateway | Translyx",
  ...
  alternates: { canonical: "/products/privexa-ai-wrapper" },
  openGraph: {
    title: "Privexa AI Wrapper — Secure LLM Gateway | Translyx",
    description: pageDescription,
    url: `${siteConfig.url}/products/privexa-ai-wrapper`,
    siteName: siteConfig.name,
    images: [{ url: siteConfig.seo.ogImage, width: 1200, height: 630, alt: "Privexa AI Wrapper" }],
  },
};
...
export default function PrivexaAIWrapperPage() {
  return (
    <>
      <Hero
        badge={{ text: "Built by Privexa · Clinically positioned through Translyx", icon: <Lock className="w-3.5 h-3.5" /> }}
        headline="Secure LLM gateway for privacy-preserving AI use"
        description="Privexa AI Wrapper helps organisations use AI systems without sending sensitive data in its original form. Sensitive fields are transformed into protected placeholders before approved AI workflows and reconstructed under controlled conditions."
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-content mx-auto">
            <div className="max-w-2xl mb-10">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-[#0F1C3F]">What AI Wrapper includes — and what it does not</h2>
            </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      Privexa AI Wrapper is developed by Privexa Limited and clinically positioned through Translyx for healthcare, diagnostics, and research workflows.
                    </p>
                  </div>
                  <a
                    ...
                    className="shrink-0 inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-[#F5F8FC] px-4 py-2.5 text-sm font-semibold text-slate-600 hover:bg-white transition-colors"
                  >
      ...
      <CTA
        title="See how AI Wrapper protects sensitive data in AI workflows"
        description="Request a walkthrough to understand how Privexa AI Wrapper fits your organisation's AI adoption and data governance requirements."
        primaryCTA={{ label: "Request walkthrough", href: "/contact" }}
        secondaryCTA={{ label: "See all products", href: "/products" }}
      />
    </>
